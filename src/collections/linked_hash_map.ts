...
import {DartLinkedHashMap} from "./collection_patch";
import {int} from "../core";

const _USE_ES6_MAPS = true /* const bool.fromEnvironment("dart2js.use.es6.maps");*/

export class DartJsLinkedHashMap<K, V> implements DartLinkedHashMap<K, V>, DartInternalMap {
