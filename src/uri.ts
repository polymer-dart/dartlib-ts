...
export class _Properties {
    ...
    _COLON : number = 58;
    _EQUALS : number = 61;
    _UPPER_CASE_A : number = 65;
    _UPPER_CASE_Z : number = 90;
    _LEFT_BRACKET : number = 91;
    _BACKSLASH : number = 92;
    _RIGHT_BRACKET : number = 93;
    _LOWER_CASE_A : number = 97;
    _LOWER_CASE_F : number = 102;
    _LOWER_CASE_Z : number = 122;
    _hexDigits : string = "0123456789ABCDEF";
    _schemeEndIndex : number = 1;
    _hostStartIndex : number = 2;
    _portStartIndex : number = 3;
    _pathStartIndex : number = 4;
    _queryStartIndex : number = 5;
    _fragmentStartIndex : number = 6;
    _notSimpleIndex : number = 7;
    _uriStart : number = 0;
    _nonSimpleEndStates : number = 14;
    _schemeStart : number = 20;
    _scannerTables : core.DartList<any> = _createTables();
}
