...
export declare class _Properties {
    ...
    _COLON: number;
    _EQUALS: number;
    _UPPER_CASE_A: number;
    _UPPER_CASE_Z: number;
    _LEFT_BRACKET: number;
    _BACKSLASH: number;
    _RIGHT_BRACKET: number;
    _LOWER_CASE_A: number;
    _LOWER_CASE_F: number;
    _LOWER_CASE_Z: number;
    _hexDigits: string;
    _schemeEndIndex: number;
    _hostStartIndex: number;
    _portStartIndex: number;
    _pathStartIndex: number;
    _queryStartIndex: number;
    _fragmentStartIndex: number;
    _notSimpleIndex: number;
    _uriStart: number;
    _nonSimpleEndStates: number;
    _schemeStart: number;
    _scannerTables: core.DartList<any>;
}
